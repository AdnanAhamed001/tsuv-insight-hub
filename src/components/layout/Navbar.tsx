...
const navLinks = [
  ...
  { name: "Portfolio", path: "/portfolio" },
  {
    ...
    dropdown: [
      ...
      { name: "🧰 Tools — Calculators & Financial Models", path: "/resources" },
      { name: "📋 Assessments — Readiness & Health Checks", path: "/resources" },
      { name: "📊 Reports — Market Insights & Case Studies", path: "/resources" },
      { name: "📰 PR Activity — Press Mentions & Awards", path: "/resources" },
      { name: "🎥 Videos — Demo Days & Masterclasses", path: "/resources" },
      { name: "🎙️ Podcasts — Interviews & Ecosystem Audio", path: "/resources" },
    ],
  },
