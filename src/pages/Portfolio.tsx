...
const companies: Company[] = [
  ...
  { name: "Togo's Momos", desc: "Togo's Momo, your go-to destination for delightful Chinese cuisine. Known for signature dishes like the Super Crunchy Momo and cheese puffs.", logo: "portfolio/togo-momos-logo.png", founderImage: "portfolio/togo-momos-founder.jpg", sector: "Food & Beverage" },
  ...
  { name: "Kamikala", desc: "A Social Impact venture with the burning desire to support the traditional Craftspeople who emigrated from Tibet in the 1960s and conserve the endangered art form.", logo: "portfolio/kamikala-logo.png", founderImage: "portfolio/kamikala-founder.png?v=2", sector: "Social Impact / Community Platforms" },
