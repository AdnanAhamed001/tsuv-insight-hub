...
const ContactUs = () => {
  ...
  return (
    <PageLayout>
      <section className="hero-gradient section-padding py-20 bg-[url('https://images.unsplash.com/photo-1516387938699-a93567ec168e?auto=format,compress&fit=crop&q=30&w=800')] bg-cover bg-center bg-blend-multiply bg-primary/90">
